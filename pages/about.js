        ...
        <div className="about-inner">
          ...
          <div className="profile-inner">
            <div className="profile-img">
              <img className="home__avatar" src="/profile.png" />
            </div>
            <div className="profile-list">
              <ul>
                <li>
                  <svg
                    className="profile-list-svg"
                    stroke="currentColor"
                    fill="currentColor"
                    stroke-width="0"
                    viewBox="0 0 12 16"
                ...
                <li>
                  ...
                  <span>rlawlsgud980@naver.com</span>
                </li>
                <li>
                  <svg
                    className="profile-list-svg"
